...
class MoveEvents final : public BaseEvents
{
	public:
		...
		uint32_t onPlayerEquip(Player* player, Item* item, slots_t slot, bool isCheck, bool isLogin = false);
		uint32_t onPlayerDeEquip(Player* player, Item* item, slots_t slot, bool isLogout);
...
typedef uint32_t (EquipFunction)(MoveEvent* moveEvent, Player* player, Item* item, slots_t slot, bool boolean, bool isLogin);
...
class MoveEvent final : public Event
{
	public:
		...
		uint32_t fireEquip(Player* player, Item* item, slots_t slot, bool boolean, bool isLogInOut);
		...
		bool executeEquip(Player* player, Item* item, slots_t slot, bool isLogInOut);
