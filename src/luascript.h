...
class LuaScriptInterface
{
	...
	protected:
		...
		static int luaCreatureGetCanMove(lua_State* L);
		static int luaCreatureSetCanMove(lua_State* L);

		static int luaCreatureGetStepDuration(lua_State* L);

		static int luaCreatureChangeHealth(lua_State* L);

		static int luaCreatureGetStringStorageValue(lua_State* L);
		static int luaCreatureSetStringStorageValue(lua_State* L);
		...
		static int luaPlayerGetVocationStar(lua_State* L);
		static int luaPlayerSetVocationStar(lua_State* L);
		static int luaPlayerGetVocationTier(lua_State* L);
		static int luaPlayerSetVocationTier(lua_State* L);
		static int luaPlayerGetVocationFragments(lua_State* L);
		static int luaPlayerSetVocationFragments(lua_State* L);
		...
		static int luaPlayerChangeMana(lua_State* L);

		static int luaPlayerGetVarStats(lua_State* L);
		static int luaPlayerAddVarStats(lua_State* L);
		static int luaPlayerGetVarSkills(lua_State* L);
		static int luaPlayerAddVarSkills(lua_State* L);

		static int luaPlayerSendStats(lua_State* L);
		static int luaPlayerSendSkills(lua_State* L);

		static int luaPlayerIsItemAbilityEnabled(lua_State* L);
		...
		static int luaVocationGetBaseTier(lua_State* L);
		...
		static int luaItemTypeGetSlotCount(lua_State* L);
		static int luaItemTypeGetWieldPosition(lua_State* L);
		...
		static int luaConditionAddConditioType(lua_State* L);
