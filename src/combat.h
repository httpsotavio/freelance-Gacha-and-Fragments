...
class DamageCallback final : public CallBack
{
	public:
		void onDamageTarget(Creature* creature, Creature* target, int32_t damage) const;
};
...
struct CombatParams {
	...
	std::unique_ptr<DamageCallback> damageCallback;
