...
void LuaScriptInterface::registerFunctions()
{
	...
	registerEnum(CALLBACK_PARAM_DAMAGETARGET)
	...
	registerEnum(CONDITION_SUPPRESS)
	...
	registerEnum(CREATURE_EVENT_EQUIP)
	registerEnum(CREATURE_EVENT_UNEQUIP)
	...
	registerMethod("Creature", "getCanMove", LuaScriptInterface::luaCreatureGetCanMove);
	registerMethod("Creature", "setCanMove", LuaScriptInterface::luaCreatureSetCanMove);

	registerMethod("Creature", "getStepDuration", LuaScriptInterface::luaCreatureGetStepDuration);

	registerMethod("Creature", "changeHealth", LuaScriptInterface::luaCreatureChangeHealth);

	registerMethod("Creature", "getStringStorageValue", LuaScriptInterface::luaCreatureGetStringStorageValue);
	registerMethod("Creature", "setStringStorageValue", LuaScriptInterface::luaCreatureSetStringStorageValue);
	...
	registerMethod("Player", "changeMana", LuaScriptInterface::luaPlayerChangeMana);

	registerMethod("Player", "getVarStats", LuaScriptInterface::luaPlayerGetVarStats);
	registerMethod("Player", "addVarStats", LuaScriptInterface::luaPlayerAddVarStats);
	registerMethod("Player", "getVarSkills", LuaScriptInterface::luaPlayerGetVarSkills);
	registerMethod("Player", "addVarSkills", LuaScriptInterface::luaPlayerAddVarSkills);
	...
	registerMethod("Player", "isItemAbilityEnabled", LuaScriptInterface::luaPlayerIsItemAbilityEnabled);
	...
	registerMethod("ItemType", "getSlotCount", LuaScriptInterface::luaItemTypeGetSlotCount);
	registerMethod("ItemType", "getWieldPosition", LuaScriptInterface::luaItemTypeGetWieldPosition);
	...
	registerMethod("Condition", "addConditioType", LuaScriptInterface::luaConditionAddConditioType);
...
int LuaScriptInterface::luaCreatureGetStorageValue(lua_State* L)
{
	...
	int32_t value;
	if (creature->getStorageValue(key, value)) {
...
int LuaScriptInterface::luaCreatureSetStorageValue(lua_State* L)
{
	...
	if (creature) {
		if (creature->getPlayer() && IS_IN_KEYRANGE(key, RESERVED_RANGE)) {
			std::ostringstream ss;
		...
		creature->addStorageValue(key, value);
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaCreatureGetCanMove(lua_State* L)
{
	// creature:getCanMove()
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature) {
...
int LuaScriptInterface::luaCreatureSetCanMove(lua_State* L)
{
	// creature:setCanMove(bool)
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature) {
		lua_pushnil(L);
		return 1;
	...
	bool canMove = getBoolean(L, 2);
	creature->setCanMove(canMove);
	pushBoolean(L, true);
	return 1;
}

int LuaScriptInterface::luaCreatureGetStepDuration(lua_State* L)
{
	...
	lua_pushnumber(L, creature->getStepDuration());
	return 1;
}

int LuaScriptInterface::luaCreatureChangeHealth(lua_State* L)
{
	...
	creature->changeHealth(getNumber<int32_t>(L, 2));
	pushBoolean(L, true);
	return 1;
}

int LuaScriptInterface::luaCreatureGetStringStorageValue(lua_State* L)
{
...
int LuaScriptInterface::luaCreatureSetStringStorageValue(lua_State* L)
{
...
int LuaScriptInterface::luaPlayerGetCurrentVocation(lua_State* L)
{
	// player:getCurrentVocation()
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
...
int LuaScriptInterface::luaPlayerRemoveVocation(lua_State* L)
{
	// player:removeVocation(id)
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		lua_pushnil(L);
		return 1;
	...
	player->removeVocation(vocation->getId());
	pushBoolean(L, true);
	return 1;
}

int LuaScriptInterface::luaPlayerGetVocationList(lua_State* L) {
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		lua_pushnil(L);
		return 1;
...
int LuaScriptInterface::luaPlayerChangeVocation(lua_State* L) {
	// player:changeVocation(id)
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		lua_pushnil(L);
		return 1;
	...
	player->changeVocation(vocation->getId());
	pushBoolean(L, true);
	return 1;
}
...
int LuaScriptInterface::luaPlayerChangeMana(lua_State* L)
{
	...
	player->changeMana(getNumber<int32_t>(L, 2));
	pushBoolean(L, true);
	return 1;
}

int LuaScriptInterface::luaPlayerGetVarStats(lua_State* L)
{
	// player:getVarStats(stat)
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		lua_pushnil(L);
		return 1;
	...
	stats_t stat = getNumber<stats_t>(L, 2);
	if (stat < STAT_FIRST || stat > STAT_LAST) {
		lua_pushnil(L);
		return 1;
	}

	lua_pushnumber(L, player->varStats[stat]);
	return 1;
}

int LuaScriptInterface::luaPlayerAddVarStats(lua_State* L)
{
	// player:addVarStats(stat, value)
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		lua_pushnil(L);
		return 1;
	...
	player->setVarStats(stat, getNumber<int32_t>(L, 3));
	pushBoolean(L, true);
	return 1;
}

int LuaScriptInterface::luaPlayerGetVarSkills(lua_State* L)
{
	// player:getVarSkills(skill)
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		lua_pushnil(L);
		return 1;
	...
	skills_t skill = getNumber<skills_t>(L, 2);
	if (skill > SKILL_LAST) {
		lua_pushnil(L);
		return 1;
	}

	lua_pushnumber(L, player->varSkills[skill]);
	return 1;
}

int LuaScriptInterface::luaPlayerAddVarSkills(lua_State* L)
{
	// player:addVarSkills(skill, value)
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		lua_pushnil(L);
		return 1;
	...
	player->setVarSkill(skill, getNumber<int32_t>(L, 3));
	pushBoolean(L, true);
	return 1;
}
...
int LuaScriptInterface::luaPlayerIsItemAbilityEnabled(lua_State* L)
{
	// player:isItemAbilityEnabled(slot)
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		lua_pushnil(L);
		return 1;
	...
	slots_t slot = getNumber<slots_t>(L, 2);
	if (slot > CONST_SLOT_LAST) {
		lua_pushnil(L);
		return 1;
	}

	pushBoolean(L, player->isItemAbilityEnabled(slot));
	return 1;
}
...
int LuaScriptInterface::luaVocationGetOutfit(lua_State* L)
{
	// vocation:getOutfit()
	Vocation* vocation = getUserdata<Vocation>(L, 1);
	if (vocation) {
		lua_pushnumber(L, vocation->getOutfit());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetSlotCount(lua_State* L)
{
	// itemType:getSlotCount()
	const ItemType* itemType = getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua_pushnumber(L, itemType->slotCount);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetWieldPosition(lua_State* L)
{
	// itemType:getWieldPosition()
	const ItemType* itemType = getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua_pushnumber(L, itemType->wieldPosition);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaConditionAddConditioType(lua_State* L)
{
	// condition:addConditioType(conditionType)
	ConditionSuppress* condition = dynamic_cast<ConditionSuppress*>(getUserdata<Condition>(L, 1));
	if (condition) {
		ConditionType_t conditionType = getNumber<ConditionType_t>(L, 2);
		pushBoolean(L, condition->addConditionType(conditionType));
	} else {
		lua_pushnil(L);
	}
	return 1;
